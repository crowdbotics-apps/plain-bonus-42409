"""
Django settings for plain_bonus_42409 project.
...
ROOT_URLCONF = 'plain_bonus_42409.urls'
...
WSGI_APPLICATION = 'plain_bonus_42409.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "plain_bonus_42409 API",
    "DESCRIPTION": "API documentation for plain_bonus_42409 App",
    "VERSION": "v1",
}
